          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <form action="index.php?p=gridview_dibatalkan" method="POST" >
           ...
           <div class="box-body">
              ...
              <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
                 ...
                 <caption>Laporan orders dibatalkan</caption>
                <thead>
                  <tr>
                    <th>Id</th>
                    <th>Products</th>
                  ...
                  <tbody>
                  <?php
                  $data = mysqli_query($conn, "SELECT * FROM checkout WHERE status_pengiriman ='dibatalkan' ORDER BY order_id ASC limit 50");
                  $no =1;
